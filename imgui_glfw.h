...
// GLFW callbacks
// - When calling Init with 'install_callbacks=true': GLFW callbacks will be
// installed for you. They will call user's previously installed callbacks, if
// any.
...
static bool ImGui_ImplGlfw_Init(GLFWwindow* window, bool install_callbacks,
    ...
    // Missing cursors will return NULL and our _UpdateMouseCursor() function
